...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
        <asp:Label ID="search" runat="server" Text="search" ForeColor="Aqua"></asp:Label>
    </p>
    <p>
    ...
    <p>
        <asp:Label ID="lbid" runat="server" Text="id" ForeColor="Aqua"></asp:Label>
    </p>
    <p>
        <asp:TextBox ID="txsearch0" runat="server" BackColor="Black" BorderColor="Aqua" ForeColor="Aqua"></asp:TextBox>
    </p>
    <p>
        <asp:Label ID="lbdevicecode" runat="server" ForeColor="Aqua" Text="devicecode"></asp:Label>
    </p>
    <p>
        <asp:TextBox ID="txsearch1" runat="server" BackColor="Black" BorderColor="Aqua" ForeColor="Aqua"></asp:TextBox>
    </p>
    <p>
        <asp:Label ID="lbdevicename" runat="server" Text="devicename" ForeColor="Aqua"></asp:Label>
    </p>
    <p>
        <asp:TextBox ID="txsearch2" runat="server" BackColor="Black" BorderColor="Aqua" ForeColor="Aqua"></asp:TextBox>
    </p>
    <p>
        <asp:Label ID="devicetype" runat="server" Text="devicetype" ForeColor="Aqua"></asp:Label>
    </p>
    <p>
        <asp:TextBox ID="txsearch3" runat="server" BackColor="Black" BorderColor="Aqua" ForeColor="Aqua"></asp:TextBox>
    </p>
    <p>
        <asp:Label ID="lbprice" runat="server" Text="price" ForeColor="Aqua"></asp:Label>
    </p>
    <p>
        <asp:TextBox ID="txsearch4" runat="server" BackColor="Black" BorderColor="Aqua" ForeColor="Aqua"></asp:TextBox>
    </p>
    <p>
        <asp:Label ID="lbifhadpreviousowner" runat="server" Text="ifhadpreviousowner" ForeColor="Aqua"></asp:Label>
    </p>
    <p>
        <asp:TextBox ID="txsearch5" runat="server" BackColor="Black" BorderColor="Aqua" ForeColor="Aqua"></asp:TextBox>
    </p>
    <p>
        <asp:Label ID="lbwarranty" runat="server" Text="warranty" ForeColor="Aqua"></asp:Label>
    </p>
    <p>
        <asp:TextBox ID="txsearch6" runat="server" BackColor="Black" BorderColor="Aqua" ForeColor="Aqua"></asp:TextBox>
    </p>
    <p>
        <asp:Label ID="lbdeviceage" runat="server" Text="deviceage" ForeColor="Aqua"></asp:Label>
    </p>
    <p>
        <asp:TextBox ID="txsearch7" runat="server" BackColor="Black" BorderColor="Aqua" ForeColor="Aqua"></asp:TextBox>
    </p>
    <p>
        <asp:Label ID="lbimage" runat="server" Text="image" ForeColor="Aqua"></asp:Label>
    </p>
    <p>
        <asp:TextBox ID="txsearch8" runat="server" BackColor="Black" BorderColor="Aqua" ForeColor="Aqua"></asp:TextBox>
    </p>
    <p>
        <asp:Label ID="btnlbl" runat="server" Text="update" ForeColor="Aqua"></asp:Label>
    </p>
    <p>
        <asp:Button ID="btnupdate" runat="server" OnClick="btnupdate_Click" Text="confirm" />
    </p>
    <p>
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderColor="Aqua" BorderWidth="4px" DataKeyNames="Id" DataSourceID="SqlDataSource1" ForeColor="Aqua" OnRowDataBound="GridView1_RowDataBound">
            <Columns>
